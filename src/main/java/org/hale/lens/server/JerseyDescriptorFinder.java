...
public class JerseyDescriptorFinder extends ClasspathDescriptorFileFinder {
    ...
    private final Logger logger = LoggerFactory.getLogger(JerseyDescriptorFinder.class);
    ...
    public List<InputStream> findDescriptorFiles() throws IOException {
        ...
        logger.info("found " + urls.size() + " descriptor files");
    ...
    private UrlMapResult openStream(final URL url) {
        ...
        try {
            ...
            logger.error("error reading mapping: " + url.toString(), e);
            ioException = e;
        }
